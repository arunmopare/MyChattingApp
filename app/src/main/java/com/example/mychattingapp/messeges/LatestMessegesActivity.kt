...
import com.example.mychattingapp.registerlogin.RegisterActivity
       ...
       // setupDummyRows()
        ...
        class LatestMessageRow (val chatMessage: ChatMessage): Item<ViewHolder>(){
            override fun bind(viewHolder: ViewHolder, position: Int) {
               viewHolder.itemView.messageview_text_latest_messages.text=chatMessage.text
                ...
                viewHolder.itemView.username_textview_latest_message.text= "what ever"
